...
<style>
    ...
    /* CRITICAL: Override all white/light text to dark colors for visibility */
    * {
    ...
    /* Widget text */
    .stCheckbox span, .stRadio label, .stMultiselect label {
        color: #2d3748 !important;
    }
    ...
    /* Success/Warning/Error boxes text */
    ...
    .element-container div:not(.metric-card) {
        color: #2d3748 !important;
    }
...
<div class="hero-section">
    ...
    <p class="hero-subtitle" style="color: #2d3748 !important;">
        <strong style="color: #667eea !important;">AI-Powered RUL Prediction System</strong><br>
        <span style="color: #4a5568 !important;">Predict Remaining Useful Life of aircraft turbofan engines using advanced Machine Learning</span><br>
        <span style="color: #4a5568 !important;">Prevent costly downtime • Improve safety • Optimize maintenance schedules</span>
    </p>
</div>
""", unsafe_allow_html=True)
